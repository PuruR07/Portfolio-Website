    ...
    <div className={`group cursor-pointer ${index % 2 !== 0 ? 'md:mt-24' : ''}`}>
      <div className="aspect-video bg-surface-container overflow-hidden mb-8 relative">
        <img 
          ...
          src={image}
        />
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-primary-container/20 backdrop-blur-sm gap-4">
