...
const Footer = () => {
  return (
    <footer className="bg-[#0a0f13] flex flex-col md:flex-row justify-between items-center px-12 py-12 w-full mt-24 pt-12 border-t border-white/5">
      <div className="font-body text-xs tracking-[0.3em] uppercase text-slate-400 mb-8 md:mb-0">
        &copy; {new Date().getFullYear()} PURU RAGHUWANSHI. ALL RIGHTS RESERVED.
      </div>
      <div className="flex gap-12">
        <a 
          className="font-body text-xs tracking-[0.3em] uppercase text-slate-400 hover:text-primary transition-colors duration-300 ease-in-out" 
